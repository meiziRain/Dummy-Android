...
import com.meizi.dummy.DummyApplication;
...
public class AudioPlayer {
    ...
    private static String CURRENT_RECORD_FILE = Constants.RECORD_DIR + "auto_";
        ...
        try {
            ...
            mHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    ToastUtil.shortMessage("已达到最大语音长度");
                }
            }, Constants.DEFAULT_AUDIO_RECORD_MAX_TIME * 1000);
        } catch (Exception e) {
    ...
    public void startPlay(String filePath, Callback callback) {
        ...
        try {
            ...
            ToastUtil.longMessage("语音文件已损坏或不存在");
            stopInternalPlay();
